...
setTimeout(function(){
    ...
    for (var i=0;i<250;i++) {="" var="" size="Math.random()" *="" 3;="" color="colors[parseInt(Math.random()*4)];" <span="" style="opacity: 1; width: 0.830662px; height: 0.830662px; top: 19.7517%; left: 83.1575%; background: rgb(236, 236, 236); box-shadow: rgb(236, 236, 236) 0px 0px 5.97225px;">
         */
